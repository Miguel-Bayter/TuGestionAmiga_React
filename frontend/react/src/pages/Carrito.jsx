    ...
    <div>
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <button
            type="button"
            className="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500 active:translate-y-px disabled:opacity-50"
                ...
                return (
                  <tr key={it.id_libro}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-sm text-gray-500">{it?.autor || '-'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{qty}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{Number.isFinite(price) ? formatMoney(price) : '-'}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{subtotal == null ? '-' : formatMoney(subtotal)}</td>
